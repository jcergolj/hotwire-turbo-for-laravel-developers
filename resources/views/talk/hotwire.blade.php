...
@section('content')
    <x-title>
        <svg width="290px" height="80px" viewBox="0 0 289.69 79.8" xmlns="http://www.w3.org/2000/svg" class="m-auto">
  ...
  <path class="bolt" d="m211.75 23-11.57 2.69 10.09-25.69-30.2 38.92 14.41-2.84-13.59 26.54 7.86-1.77-7.95 18.95 24.97-26.97-9.21 2.13z"></path>
    ...
    <x-body>
        <x-ul>
        <li>what Livewire & Alpine is for Laravel, that's Hotwire for Ruby on Rails</li>
        <li>it sends HTML not JSON without using much JavaScript</li>
        <li>
            <x-link href="https://hotwired.dev/" target="_blank">Hotwire</x-link>
            consists of 3 tools <x-link href="https://turbo.hotwired.dev/" target="_blank">Turbo</x-link>, Stimulus and Strada (native controls, driven by your web app)
        </li>
